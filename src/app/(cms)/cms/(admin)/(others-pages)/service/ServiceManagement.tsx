...
// import { Service, ServiceFeature, CreateServiceRequest, UpdateServiceRequest } from "@/app/types";
...
//     const [formData, setFormData] = useState<CreateServiceRequest | UpdateServiceRequest>(initialFormData);
...
//                 await serviceApi.update(formData as UpdateServiceRequest);
//             } else {
//                 await serviceApi.create(formData as CreateServiceRequest);
//             }
...
//         const confirmMsg = featureCount > 0
...
//                                 name="icon"
//                                 type="text"
//                                 placeholder="fa-globe, fa-code..."
//                                 value={formData.icon || ""}
//                                 onChange={handleChange}
//                                 hint="Class icon (FontAwesome, Lucide...)"
//                             />
//                         </div>
...
//                                     <div
//                                         key={index}
//                                         className={`relative p-4 rounded-lg border ${errors[`feature_${index}`]
...
//                                                     onChange={(e) =>
//                                                         handleFeatureChange(index, "displayOrder", parseInt(e.target.value) || 1)
//                                                     }
//                                                 />
//                                             </div>
...
//                                             {service.icon ? (
//                                                 <span className="inline-flex items-center justify-center w-8 h-8 bg-brand-50 text-brand-600 rounded-lg dark:bg-brand-500/10 dark:text-brand-400">
...
//                     <div className="p-5">
//                         {formData.features.length === 0 ? (
//                             <p className="text-gray-500 text-center py-4">Chưa có tính năng nào</p>
//                         ) : (
...
//                                         >
//                                             <CheckCircleIcon className="w-5 h-5 text-success-500 shrink-0" />
...
import IconPicker from "@/app/(cms)/cms/components/shared/IconPicker";
